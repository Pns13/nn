...
'''
	...
	cetak(nel(oi, title='[bold purple] • 🄺🄴🄽🄳🄰🄺 🄺🄰🄱🄰 🄻🄰 • [/bold purple]'))
# VALIDASI TOKEN
def login():
		try:
...
def menu(my_name,my_id):
	...
	print(k+'['+h+'•'++'] IP ADDRESS  : '+str(sh['origin']))
...
def file():
	...
	print(k+'['+h+'•'+k+'] MBUKAK FILE, TUNGGU KUDAI •••')
	time.sleep(2)
...
def dump_publik():
	...
	sol().print(win2)
	print(k+'['+h+'•'+k+'] TYPE "me" AMAW NDAK COLI PAKAI ID KABA TULA')
	pil = input(k+'['+p+'f'+k+'] ID YAW NDAK KABA COLI KA : ')
	try:
...
def dump_massal():
	...
	if pilih in ['1','01']:
		...
		ses=requests.Session()
		yz = 0
		print(k+'['+h+'•'+k+'] TYPE "me" AMAW NDAK ALAP')
